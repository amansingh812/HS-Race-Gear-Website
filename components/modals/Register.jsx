...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await registerUser(name, formData.email, formData.password, formData.confirmPassword);
      ...
      if (result.success) {
        ...
        alert('Registration successful! Welcome to HS Race Gear!');
        ...
        <div className="canvas-body popup-inner">
          <form onSubmit={handleSubmit} className="form-login">
            ...
            <div className="bot">
              ...
              <div className="other-login mt-4">
                <p className="text-sm text-center text-main-2">Or sign up with:</p>
