...
const ALL_POSTS = [
  ...
  },
  {
    ...
    tag: "Safety Standards",
    image: "/images/blog/tpp-rating-explained.webp",
  ...
  },
  {
    ...
    tag: "Discipline Guide",
    image: "/images/blog/drag-racing-suit-requirements.webp",
  ...
  },
  {
    ...
    tag: "Import Guide",
    image: "/images/blog/racing-suit-hs-code.webp",
  ...
  },
  {
    ...
    tag: "Discipline Guide",
    image: "/images/blog/sfi-rated-racing-suit-by-class.webp",
  ...
  },
  {
    ...
    tag: "Buyer's Guide",
    image: "/images/blog/aftermarket-racing-suits.webp",
  ...
  },
  {
    ...
    tag: "Safety",
    image: "/images/blog/understanding-sfi-certifications.webp",
  ...
  },
  {
    ...
    tag: "Discipline Guide",
    image: "/images/blog/choose-right-racing-suit.webp",
  ...
  },
  {
    ...
    tag: "Custom Fit",
    image: "/images/blog/perfect-custom-fit-racing-suit.webp",
    ...
    <section className="blog-listing-section" style={{ paddingTop: "0" }}>
      <div className="container">
        <div className="blog-listing-header">
          <div>
            {/* Uses .blog-listing-heading from compare.css, not .hs-doc-heading —
                hs-doc-theme.css isn't imported on every page that renders this
                component, which left the heading unstyled and invisible against
                the dark section background. */}
            <h2 className="blog-listing-heading" style={{ margin: 0 }}>{sectionHeading}</h2>
