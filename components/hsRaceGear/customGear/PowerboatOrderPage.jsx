...
/* ============================================
   DATA — Custom Power Boat Suit Order
   ============================================ */
  ...
  return (
    <div className="step-content">
      ...
      <div className="color-selection-area">
        ...
        >
          {!selections.primary && <div className="color-preview-label">Select colors below</div>}
        </div>
          ...
          {colorAreas.map((area) => (
            <div key={area.key}>
              <div className="color-section-title">
                {area.label}
                {selections[area.key] && <span className="color-name-tag" style={{ marginLeft: 12 }}>{selections[area.key].name}</span>}
              </div>
...
/* ============================================
   MAIN COMPONENT
   ============================================ */
export default function PowerboatOrderPage() {
  ...
  const orderDataForSummary = { package: selectedPackage, suitMockup, glovesMockup, shoesMockup, colors };
