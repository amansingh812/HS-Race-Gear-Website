        ...
        <>
            ...
            <section style={{ padding: "96px 0", backgroundColor: "#171717" }}>
                <div className="container" style={{ maxWidth: "900px", padding: "0 24px", margin: "0 auto" }}>
                    <div className="karting-measure-cta">
                        ...
                        <p style={{
                            ...
                            Getting the right measurements is key to a perfect fit. Follow our step-by-step measurement guide to ensure your karting suit fits like a glove.
                        </p>
            ...
            <section style={{
                ...
                <div className="container" style={{ maxWidth: "800px", padding: "0 24px", margin: "0 auto", textAlign: "center" }}>
                    <h2 style={{
                        ...
                        Ready to Get Your Custom Karting Suit?
                    </h2>
                    <p style={{
                        color: "#9ca3af",
                        fontSize: "1.125rem",
                        ...
                        Join drivers worldwide who trust HS Race Gear for their custom karting suits. Start your order today and stand out on the track.
                    </p>
                    <div style={{
                        display: "flex",
                        flexDirection: "column",
