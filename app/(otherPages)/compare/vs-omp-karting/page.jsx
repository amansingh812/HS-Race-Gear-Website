...
const data = KART_COMPARE["omp"];

export const metadata = {
  alternates: { canonical: "https://www.hsracegear.com/compare/vs-omp-karting" },
  title: "OMP Kart Suits Alternative — Custom From $329",
  description:
    "Comparing OMP kart suits? HS Race Gear builds CIK Level 2 karting suits to your exact measurements from $329 — unlimited design options, made in the USA with a 2–3 week turnaround.",
  ...
  openGraph: {
    ...
    description:
      "Comparing OMP kart suits? HS Race Gear builds CIK Level 2 karting suits to your exact measurements from $329 — unlimited design options, made in the USA with a 2–3 week turnaround.",
    url: "https://www.hsracegear.com/compare/vs-omp-karting",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "HS Race Gear vs OMP Karting", "item": "https://www.hsracegear.com/compare/vs-omp-karting" },
  ],
};
